...
@Component
@PlaceDetailsConverter.Component(country = "US")
public class PlaceDetailsConverter_US extends DefaultPlaceDetailsConverter {
    @Override
        ...
        if (StringUtils.isBlank(buildingName) && StringUtils.isNotBlank(placeName)) {
            ...
            if (route != null) {
                ...
                if (streetNumber != null) {
                    street = streetNumber.getLongText() + " " + route.getShortText();
                } else {
                    street = route.getShortText();
                }
